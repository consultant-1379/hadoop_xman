 ...
 * -----------------------------------------------------------------------
 */
package com.ericsson.oss.itpf.datalayer.modelservicelib.codec.helper;
...
public class DefaultValues {
    ...
    public static final short DEFAULT_SHORT_VALUE = -1;

    public static final byte DEFAULT_BYTE_VALUE = -1;
