...
public class BinaryFormatterTest {
	...
	public void testFormatNullBytes() {
		...
		byte[] nullTest = null;
		byte[] i = BinaryFormatter.doFormat(nullTest, 2);
	...
	public void testFormatByteArray() throws Exception {
		...
		byte[] i = BinaryFormatter.doFormat(testBytes, 4);
	...
	public void testFormatString() throws Exception {
		...
		/* Calling the tested method */
		byte[] i = BinaryFormatter.doFormat("text", 4);
	...
	public void testFormatTooShortString() throws Exception {
		...
		/* Calling the tested method */
		byte[] i = BinaryFormatter.doFormat("t", 2);
		String actual = i[0] + "," + i[1] + "," + i[2];
	...
	public void testFormatTooLongString() throws Exception {
		...
		/* Calling the tested method */
		byte[] i = BinaryFormatter.doFormat("test", 2);
		String actual = i[0] + "," + i[1] + "," + i[2];
