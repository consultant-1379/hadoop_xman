...
public class HiveTableTestDDL {
    ...
    public void testGetDDL() {
        ...
        final String expected = "create table if not exists " + TEST_DB_NAME + "." + TEST_TABLE_NAME
    ...
    public void testGetDDLNoDbName() {
        ...
        final String expected = "create table if not exists " + TEST_TABLE_NAME
                + " (Column1 bigint COMMENT 'Comment', Column2 smallint COMMENT 'Comment 2', Column3 int COMMENT 'Comment 3')"
                + new HiveComment(TEST_COMMENT).getDDL();
        assertEquals(expected, testTable.getDDL());
    }
    ...
    public void testGetDDLSingleColumn() {
        ...
        final String expected = "create table if not exists " + TEST_DB_NAME + "." + TEST_TABLE_NAME + " (Column1 bigint COMMENT 'Comment')"
                + new HiveComment(TEST_COMMENT).getDDL();
        assertEquals(expected, testTable.getDDL());
    }
    ...
    public void testGetDDLWithPatitions() {
        ...
        final String expected = "create table if not exists "
                + TEST_DB_NAME
                + "."
                + TEST_TABLE_NAME
                + " (Column1 bigint COMMENT 'Comment', Column2 smallint COMMENT 'Comment 2', Column3 int COMMENT 'Comment 3')"
    ...
    public void testGetDDLWithClusterBy() {
        final HiveClusterBy clusterBy = new HiveClusterBy(NUMBER_OF_TEST_BUCKETS);
    ...
    @Test
    public void testGetDDLFileFormt() {
        testTable.setColumns(multiColumnList);
        testTable.setFileFormat(HiveFileFormat.RCFILE);

        String expected = "create table if not exists " + TEST_DB_NAME + "." + TEST_TABLE_NAME
                + " (Column1 bigint COMMENT 'Comment', Column2 smallint COMMENT 'Comment 2', Column3 int COMMENT 'Comment 3')"
                + new HiveComment(TEST_COMMENT).getDDL() + " STORED AS RCFILE";
        assertEquals(expected, testTable.getDDL());

        // reset to default format and test again
        testTable.setFileFormat(HiveFileFormat.TEXTFILE);

        expected = "create table if not exists " + TEST_DB_NAME + "." + TEST_TABLE_NAME
                + " (Column1 bigint COMMENT 'Comment', Column2 smallint COMMENT 'Comment 2', Column3 int COMMENT 'Comment 3')"
                + new HiveComment(TEST_COMMENT).getDDL();
        assertEquals(expected, testTable.getDDL());
    }
    ...
    @Test
    public void testGetDDLDelimiter() {
        testTable.setColumns(multiColumnList);
        testTable.setDelimiter(",");

        String expected = "create table if not exists " + TEST_DB_NAME + "." + TEST_TABLE_NAME
                + " (Column1 bigint COMMENT 'Comment', Column2 smallint COMMENT 'Comment 2', Column3 int COMMENT 'Comment 3')"
                + new HiveComment(TEST_COMMENT).getDDL() + " ROW FORMAT DELIMITED FIELDS TERMINATED BY ','";
        assertEquals(expected, testTable.getDDL());

        // reset to default delimiter and test again
        testTable.setDelimiter("");
    ...
    @Test
    public void testGetDDLDelimiterFileFormt() {
        testTable.setColumns(multiColumnList);
        testTable.setFileFormat(HiveFileFormat.RCFILE);
        testTable.setDelimiter(",");
        ...
        final String expected = "create table if not exists " + TEST_DB_NAME + "." + TEST_TABLE_NAME
                + " (Column1 bigint COMMENT 'Comment', Column2 smallint COMMENT 'Comment 2', Column3 int COMMENT 'Comment 3')"
                + new HiveComment(TEST_COMMENT).getDDL() + " ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS RCFILE";
        assertEquals(expected, testTable.getDDL());
    }
}
