...
public class HiveTableTestBasic {
    ...
    public void testSetGetFileFormat() {
        // check default file format is TEXTFILE
        assertEquals(HiveFileFormat.TEXTFILE, testTable.getFileFormat());

        testTable.setFileFormat(HiveFileFormat.RCFILE);
        assertEquals(HiveFileFormat.RCFILE, testTable.getFileFormat());
    }

    @Test
    public void testSetGetDelimiter() {
        // check default delimiter is empty
        assertEquals("", testTable.getDelimiter());
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testSetNullDelimiter() {
        testTable.setDelimiter(null);
    }
}
